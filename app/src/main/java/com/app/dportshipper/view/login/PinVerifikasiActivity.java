...
public class PinVerifikasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvKirimUlang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final SweetAlertDialog pDialog = new SweetAlertDialog(PinVerifikasiActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                    ...
                    public void onResponse(Call<ResKirimUlang> call, Response<ResKirimUlang> response) {
                        ...
                        if (response.code() == 200) {
                            ...
                            if(resKirimUlang.getMessage().equals("sukses")){
                                new SweetAlertDialog(PinVerifikasiActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            pDialog.dismissWithAnimation();
                            new SweetAlertDialog(PinVerifikasiActivity.this, SweetAlertDialog.ERROR_TYPE)
