...
public class StateProgressBarCustom extends View {
    ...
    private static final int MAX_STATE_NUMBER = 10;
    ...
    public StateProgressBarCustom(Context context) {
        this(context, null, 0);
    }

    public StateProgressBarCustom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StateProgressBarCustom(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initStateProgressBar(Context context) {
        ...
        mMaxStateNumber = StateNumber.TEN.getValue();
    ...
    public boolean performClick() {
        ...
        if (mOnStateItemClickListener != null) {
            ...
            //mOnStateItemClickListener.onStateItemClick(StateProgressBarCustom.this, getStateItem(mStateItemClickedNumber), mStateItemClickedNumber, getCurrentStateNumber() == mStateItemClickedNumber);
