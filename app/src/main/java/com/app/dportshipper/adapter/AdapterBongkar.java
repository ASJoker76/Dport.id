...
public class AdapterBongkar extends RecyclerView.Adapter<AdapterBongkar.ViewHolder> {

    private Context context;
    private ArrayList<ResDataFotoBongkarBarang> dataPengiriman;
    private int lastPosition = -1;
    private ListBongkarMuatBinding viewBinding;

    private final static int FADE_DURATION = 1000; //FADE_DURATION in milliseconds

    public AdapterBongkar(Context context,ArrayList<ResDataFotoBongkarBarang> dataPengiriman) {
    ...
    @NonNull
    @Override
    public AdapterBongkar.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterBongkar.ViewHolder(viewBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterBongkar.ViewHolder holder, int position) {
        ResDataFotoBongkarBarang resBursaPengiriman = dataPengiriman.get(position);
        Glide.with(context)
